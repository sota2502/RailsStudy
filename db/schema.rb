...
ActiveRecord::Schema.define(version: 20160505081804) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.integer  "mythread_id", limit: 4
  end

  add_index "comments", ["mythread_id"], name: "index_comments_on_mythread_id", using: :btree
  ...
  create_table "mythreads", force: :cascade do |t|
  ...
  add_index "mythreads", ["user_id"], name: "index_mythreads_on_user_id", using: :btree
